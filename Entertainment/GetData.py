...
with open('Extracted_csv/EntLinks.csv') as f:
    reader = csv.reader(f)
    data = list(reader)
...
while num_of_links < 1121:
    ...
    hq_maybes = ["Melbourne", "Victoria", "Cairns", "Queensland", "Gold", "Coast", "QLD", "Brisbane", "Sydney",
                 ...
                 "Surrey Hills", "Ascot Park", "Baldivis", "WA", "Denmark", "Belrose", "South", "Wales", "London"
                 ...
                 "Glynde", "Flinders Park", "Craigieburn", "Murarrie", "Cottesloe", "Sydney, NSW"]

    spec_maybes = ["live", "entertainment", "Concerts", "Festivals", "film", "awards", "television", "Arts", "Paints",
                   "Events", "lighting", "music", "productions", "theatre", "staging", "audio", "LED", "screens",
                   "projectors", "backline", "concerts", "festivals", "churches", "school", "events", "Design", "Hire",
                   "Equipment", "service", "needs", "scale", "Digital", "Subtitling", "content", "radio", "online",
                   "Media", "Applications", "mobile", "filmmaking", "directing", "producing", "editing", "sound",
                   "colour", "grading", "business", "education", "short course", "podcasting", "video", "screenwriting",
                   "content creation", "training", "Drama", "Entertainment", "Games", "Centres", "amusement", "esports",
                   "Parties", "party", "brand", "marketing", "branding", "planning", "management", "promotion", "dance",
                   "casting", "choreography", "DJ's", "Performers", "Fundraising", "Publishing", "Marketing", "sales"]
...
ourdata.to_csv("Extracted_csv/EntertainmentDataX.csv", mode='a', index=False, header=False)
