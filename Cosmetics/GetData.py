...
with open('Extracted_csv/CosmeticsLinks.csv') as f:
    reader = csv.reader(f)
    data = list(reader)
...
def login():
    ...
    username.send_keys('hilksbill@gmail.com')

    # locate password form by_class_name
    password = driver.find_element_by_id('password')

    # send_keys() to simulate key strokes
    password.send_keys('qwertyuiopasdfghjkl')
...
while num_of_links < 1000:
    ...
    type_maybes = ["Privately", "Privately Held", "Public Company", "Held", "Self-Employed", "Educational Institution",
                   "Proprietorship", "Sole Proprietorship", "Nonprofit", "Partnership", "Government Agency"]
    ...
    hq_maybes = ["Melbourne", "Victoria", "Cairns", "Queensland", "Gold", "Coast", "QLD", "Brisbane", "Sydney",
                 ...
                 "Kings Park", "NSW", "Hills", "Laverton", "North", "Victoria", "Adelaide", "SA", "Brisbane",
                 ...
                 "Mandurah", "Melrose Park", "South Australia", "Belmont", "Burleigh Heads", "Qld", "Malaga",
                 "Glynde", "Flinders Park", "Craigieburn", "Murarrie", "Cottesloe", "Sydney, NSW", "London",
                 "California", "Berlin", "Paris", "CA", "DC", "Liverpool", "Amsterdam", "Ohio", "TX", "CT",
                 "Missouri", "Kentucky", "New Jersey", "Hong Kong", "SC", "NC", "Michigan", "Illinois", "New York",
                 "Tokyo", "Atlanta", "NY", "CA", "Connecticut", "Florida", "Amsterdam", "Seoul"]

    spec_maybes = ["Cosmetics", "Beauty", "Personal", "Consumer", "Luxury", "Pharmacy", "research", "innovation",
                   "retail", "Marketing",   "technology", "Management", "Services", " and", "development", "Solutions",
                   "Care", "brand", "sales", "Distribution", "Product", "Accessories", "fashion", "manufacturing",
                   "Skin", "Body", "Fragrances", "Makeup", "Hair", "Perfume", "Woman", "Wellness",  "Lifestyle",
                   "Natural", "Health", "Skincare"]
...
ourdata.to_csv("Extracted_csv/CosmeticsData.csv", mode='a', index=False, header=False)
