...
def login():
    theurl = 'https://www.linkedin.com/checkpoint/rm/sign-in-another-account?fromSignIn=true&trk=guest_homepage' \
...
driver.get('https://www.linkedin.com/search/results/companies/?companyHqGeo=%5B%22100506852%22%5D&industry=%5B%2218'
           '%22%5D&origin=FACETED_SEARCH')
...
while page < 101:
    ...
    url = 'https://www.linkedin.com/search/results/companies/?companyHqGeo=%5B%22100506852%22%5D&industry=%5B%2218%22' \
          '%5D&origin=FACETED_SEARCH&page=' + pg + ' '


    # Control loop by ↓
    # Pause the loop by random secs to simulate human behavior.
    # sleep(randint(10, 105))
...
companies.to_csv('Extracted_csv/CosmeticsLinks.csv', mode='a', header=None, index=None)
