...
"""driver.get('https://www.linkedin.com/search/results/companies/?companyHqGeo=%5B%22101452733%22%5D&industry=%5B%2247'
...
while page < 101:
    ...
    url = 'https://www.linkedin.com/search/results/companies/?companyHqGeo=%5B%22101452733%22%5D&industry=%5B%2247%22' \
          '%5D&origin=FACETED_SEARCH&page=' + pg + ' '

    """url = 'https://www.linkedin.com/search/results/companies/?companyHqGeo=%5B%22100506852%22%5D&industry=%5B%2280%22' \
...
companies.to_csv('Extracted_csv/AccountingLinks.csv', mode='a', header=None, index=None)
