...
with open('Extracted_csv/AccountingLinks.csv') as f:
    reader = csv.reader(f)
    data = list(reader)
...
while num_of_links < 1000:
    ...
    spec_maybes = ["Accounting", "accounting", "Bookkeeping", "Training", "Budgeting", "Reporting", "Compliance",
                   "Financial", "Management", "Charities", "Associations", "Social" "Enterprises", "Governance",
                   "Tax", "Return", "Business", "Service",  "Investment", "Reports", "Payroll", "Cash", "Accounts",
                   "Payable", "Auditing", "Outsourcing", "Bookkeepers", "Advisory", "Taxation", "Planning", "Audit",
                   "Wealth", "Operations", "SMSF", "Lending", "Strategy", "Performance", "Valuation", "NFP"]
...
ourdata.to_csv("Extracted_csv/AccountingData.csv", mode='a', index=False, header=False)
