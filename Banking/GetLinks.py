...
# ('/Users/imaki/Desktop/x88/chromedriver')
...
"""driver.get('https://www.linkedin.com/search/results/companies/?companyHqGeo=%5B%22101452733%22%5D&industry=%5B%2241'
...
while page < 101:
    ...
    url = 'https://www.linkedin.com/search/results/companies/?companyHqGeo=%5B%22101452733%22%5D&industry=%5B%2241%22' \
...
companies.to_csv('Extracted_csv/BankingLinks.csv', mode='a', header=False, index=None)
